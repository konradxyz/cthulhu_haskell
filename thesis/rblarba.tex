...
Pe³na implementacja jêzyka Cthulhu sk³ada siê z dwóch czê¶ci.
...
Opisywana w tym dokumencie realizacja cthulhu t³umaczy
kod wej¶ciowy na kod C++.
Pe³na implentacja tego jêzyka sk³ada siê z dwóch czê¶ci. Pierwsz± z nich jest
napisany w Haskellu generator kodu. Jego zadaniem jest statyczna
analiza programu wej¶ciowego. Generator kodu sprawdza poprawno¶æ
kodu a tak¿e dba o optymalizacje oraz wybór wyra¿eñ które bêd±
obliczane równolegle. Drugim elementem jest przygotowane w C++
